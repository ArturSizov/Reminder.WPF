...
namespace Reminder.Services.Toolkit
{
    public class NotifyIconWrapper : FrameworkElement, IDisposable
    {
        ...
        {
            var openItem = new ToolStripMenuItem(Dict.Translate(Dict.Parameter.Taskbar_open));
            openItem.Click += OpenItemOnClick;

            var exitItem = new ToolStripMenuItem(Dict.Translate(Dict.Parameter.Taskbar_close));
